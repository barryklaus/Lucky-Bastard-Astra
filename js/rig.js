...
if(a.top===9){LB.text(c,'13',tx,ty+57,35,'#dfd1a9','Impact','center');L(c,[tx-w+8,ty+26,tx-w+4,ty+46],'#dfd1a9',5)}
P(c,`M${tx-w+13} ${ty+35} l10 7 -12 4 M${rx-hip+8} ${ry-20} l14 3 M${rx+hip-7} ${ry-15} l-15 4`,null,LB.shade(a.cloth,-48),1.6);
